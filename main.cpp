...
const char PLAYER_SPRITE_FILEPATH[] = "tiger.png";
...
glm::mat4 view_matrix, model_matrix, mmx2, projection_matrix, trans_matrix;
...
void update()
{
    ...
    mmx2 = glm::translate(mmx2, glm::vec3(t_x_2, 0.0f, 0.0f));
    mmx2 = glm::rotate(mmx2, glm::radians(triangle_rotate), glm::vec3(0.0f, 0.0f, 1.0f));
}
...
void render() {
    ...
    draw_object(mmx2, player_texture_id);
